...
function show(args) {
    let toDisplay = CURRENT_NODE.cloneNode(true);
...
function printTOC(entry, depth) {
    ...
    printLine(`${indent}${entry.name}${desc}`);
...
function where(args) {
    ...
    printLine(`This is a ${CURRENT_NODE.tagName} node.`);
    // TODO: other useful info here?
}
